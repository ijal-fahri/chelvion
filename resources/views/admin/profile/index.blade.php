...
<body>
    <div class="relative min-h-screen md:flex">
        ...
        <div class="flex-1 md:ml-64 flex flex-col">
            <main class="flex-grow p-4 sm:p-6 lg:p-8 animate-fade-in">
                ...
                {{-- Memanggil Header dari Partials --}}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {{-- [DIUBAH] Kolom Kiri: Menambahkan Alamat & Telepon Cabang --}}
                    <div class="lg-col-span-1 space-y-8">
                        <div class="bg-white p-6 rounded-2xl shadow-lg">
                            <div class="flex flex-col items-center text-center">
                                <div class="relative">
                                    <img src="https://placehold.co/128x128/eef2ff/4f46e5?text=Admin" alt="Foto Profil" class="w-32 h-32 rounded-full mb-4 border-4 border-white shadow-md">
                                ...
                                <h3 class="text-2xl font-bold text-gray-800">Nama Admin</h3>
                                <p class="text-gray-500">admin@example.com</p>
                            </div>
                            <hr class="my-6 border-gray-200">
                            <div class="space-y-4 text-sm">
                                <div class="flex justify-between">
                                    <span class="font-semibold text-gray-600">Nomor Cabang:</span>
                                    <span class="text-gray-800 text-right">Pusat</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-semibold text-gray-600">Alamat Cabang:</span>
                                    <span class="text-gray-800 text-right">Jl. Jenderal Sudirman Kav. 50, Jakarta</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-semibold text-gray-600">Telepon Cabang:</span>
                                    <span class="text-gray-800 text-right">021-987654</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-semibold text-gray-600">Bergabung:</span>
                                    <span class="text-gray-800 text-right">12 Januari 2023</span>
                                </div>
                            </div>
    ...
    {{-- [DIUBAH] Modal untuk Edit Profil disesuaikan --}}
    <div id="edit-profile-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 hidden z-50">
        <div class="modal-content bg-white w-full max-w-md p-6 rounded-2xl shadow-xl transform scale-95">
            ...
            <form id="edit-profile-form" action="#" method="POST" class="space-y-4">
                <div>
                    <label for="modal_nama_lengkap" class="block mb-2 text-sm font-medium text-gray-600">Nama Lengkap</label>
                    <input type="text" id="modal_nama_lengkap" value="Nama Admin" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label for="modal_email" class="block mb-2 text-sm font-medium text-gray-600">Alamat Email</label>
                    <input type="email" id="modal_email" value="admin@example.com" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" readonly>
                </div>
                 <div>
                    <label for="modal_nomor_cabang" class="block mb-2 text-sm font-medium text-gray-600">Nomor Cabang</label>
                    <input type="text" id="modal_nomor_cabang" value="Pusat" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed" readonly>
                </div>
                <div>
                    <label for="modal_alamat_cabang" class="block mb-2 text-sm font-medium text-gray-600">Alamat Cabang</label>
                    <textarea id="modal_alamat_cabang" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">Jl. Jenderal Sudirman Kav. 50, Jakarta</textarea>
                </div>
                <div>
                    <label for="modal_telepon_cabang" class="block mb-2 text-sm font-medium text-gray-600">Telepon Cabang</label>
                    <input type="tel" id="modal_telepon_cabang" value="021-987654" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
